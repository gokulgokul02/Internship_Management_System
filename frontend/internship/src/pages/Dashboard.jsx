...
import Layout from "../components/Layout"; // Make sure to import 
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5000/api/dashboard", headers);
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Welcome to your internship management dashboard
                </p>
              </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-green-600">{stats.students.approved}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Pending Approval</span>
                      <span className="font-semibold text-yellow-600">{stats.students.pending}</span>
                    </div>
                    <div className="pt-2">
                          ...
                          style={{ 
                            width: `${
                              stats.overview.totalStudents > 0 
                                ? (stats.students.approved / stats.overview.totalStudents) * 100 
                                : 0
                            }%`
                          }}
                        ></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Link to="/payments" className="group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:border-green-300 h-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    View payment transactions, revenue reports, and payment history
                  </p>
                  <div className="text-green-600 font-medium text-sm">View Payments →</div>
                </div>
              </div>
            </Link>
            ...
            <Link to="/certificates" className="group">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:border-yellow-300 h-full">
                <div className="text-center">
                  ...
                  <div className="text-yellow-600 font-medium text-sm">View Certificates →</div>
                </div>
              </div>
            </Link>
          </div>
